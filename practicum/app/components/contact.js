    ...
    return (
      <section id="contact" className={`d-flex flex-lg-row flex-column`}>
        ...
        <div className={`${styles["contact-details"]} w-lg-50 text-center text-lg-start p-4`}>
            ...
            <Link href="https://github.com/meisprout" target="blank">
              <button className={`btn`}>
            ...
            <Link href="https://www.linkedin.com/in/andrea-mei-maala-92b9a3248/" target="blank">
              <button className={`btn`}>
            ...
            <div className={`d-flex gap-3 mt-3`}>
              <Link href="mailto:eahxmaala@gmail.com" target="blank">
                <button className={`btn`}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
                  <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414zM0 4.697v7.104l5.803-3.558zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586zm3.436-.586L16 11.801V4.697z"/>
                  </svg> eahxmaala@gmail.com
                </button>
              </Link>
              
              <Link href="tel:09260310012" target="blank">
                <button className={`btn`}>
