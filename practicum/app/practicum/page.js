...
export default function Practicum() {
    return (
      ...
      <Nav/>
      <section id="practicum" className={`d-flex`}>
            <TOC/>
            <div className={`${styles["practicum-main"]} overflow-auto`}>
              ...
              <div id="outputs" className={`mt-4 d-flex flex-column align-items-center`}>
                ...
                <p className={`mt-4`}>
                I implemented each requirement per use case to ensure the flow makes sense.
                <ul>
                  <li><span className={`fw-bold`}>USE CASE 1:</span> Set up the main view for all product labels. Validation for free and paid users is
                  ...
                  <li><span className={`fw-bold`}>USE CASE 2:</span> Implemented form functionalities for custom label creation, real time editing, and custom label saving.
                  The new custom label will be seen on the main view after saving.
                  </li>
                  <li><span className={`fw-bold`}>USE CASE 3:</span> Implemented product label view layout with its corresponding details matching the preview appearance. Also included the list of relevant information such as
                  ...
                  <li><span className={`fw-bold`}>USE CASE 4:</span> Set up the main view for all product labels. Validation for free and paid users is
                  also implemented, where paid users are only allowed to add new labels while free users will be prompted to upgrade once they click the "Add Product Label" button.
                  </li>
                  <li><span className={`fw-bold`}>USE CASE 5:</span> Set up the main view for all product labels. Validation for free and paid users is
                  also implemented, where paid users are only allowed to add new labels while free users will be prompted to upgrade once they click the "Add Product Label" button.
                  </li>
                  <li><span className={`fw-bold`}>USE CASE 6:</span> Set up the main view for all product labels. Validation for free and paid users is
                  also implemented, where paid users are only allowed to add new labels while free users will be prompted to upgrade once they click the "Add Product Label" button.
                  </li>
                </ul>
                </p>
...
senior dev about possible setups.</li>
              ...
              <div id="synthesis" className={`mt-4 d-flex flex-column align-items-center`}>
                ...
                <p className={`mt-4`}>Even though I have worked in numerous systems for laboratory activities and thesis, the
                  ...
                  since one small mistake can affect how a client perceives our product.
                  Despite having a mixed setting of remote and onsite, Prosperna promotes constant
                  ...
                  All of my accomplishments in Prosperna is possible thanks to the guidance of my fellow
                  ...
                  process, they allowed me to improve my skills as a developer.
                  41
                  With the experience that I have gathered in Prosperna, I greatly improved not only my
                  technical skills in coding, UX/UI design, and project management, but also my soft skills,
                  including creativity, accountability, transparency, and eagerness to challenge myself everyday.
                  </p>
              </div>
